...
///////////////////////////////////////////////////////////////////////////////////
// File copied off the web.  Added the 'static' before IID_ISampleGrabberCB to
// avoid multiply-defined symbol issue.
// This file disappeared from the Microsoft developer kits somewhere along the
// way but is needed to compile the DirectShot parts of the video project.
...
static IID IID_ISampleGrabberCB = { 0x0579154A, 0x2B53, 0x4994, { 0xB0, 0xD0, 0xE7, 0x73, 0x14, 0x8E, 0xFF, 0x85 } };
