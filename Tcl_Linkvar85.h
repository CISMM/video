...
typedef	void	(*Linkvar_Intcall)(const int new_value, void *userdata);
typedef	void	(*Linkvar_Floatcall)(const float new_value, void *userdata);
typedef	void	(*Linkvar_Selectcall)(const char *new_value, void *userdata);
typedef	void	(*Linkvar_Checkcall)(const char *entry, int new_value,void *userdata);
