...
mkdir -p vrpn
cd vrpn
cmake ../../vrpn -DVRPN_USE_WIIUSE:BOOL=FALSE -DVRPN_BUILD_CLIENTS:BOOL=FALSE -DVRPN_BUILD_SERVERS:BOOL=FALSE -DBUILD_TESTING:BOOL=FALSE -DVRPN_USE_LIBUSB_1_0:BOOL=FALSE
make
sudo make install
cd ..
mkdir -p video
